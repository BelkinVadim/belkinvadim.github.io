...
var _caseMap = __webpack_require__(10);
...
var _propertyEffects = __webpack_require__(21);
...
const AppRouteConverterBehavior = exports.AppRouteConverterBehavior = {
  properties: {
    /**
     * A model representing the deserialized path through the route tree, as
     * well as the current queryParams.
...
var _ironMeta = __webpack_require__(28);
...
class CurrencyItem extends _polymerElement.Element {
    ...
    static get template() {
        return `
            ...
            <a class="paper-item-link" href="#/currency/{{currency.id}}" tabindex="-1">
