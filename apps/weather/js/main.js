...
var _config$api = _config2.default.api,
    baseUrl = _config$api.baseUrl,
    key = _config$api.key,
    type = _config$api.type,
    units = _config$api.units;

var params = 'units=' + units + '&type=' + type + '&appid=' + key;

exports.default = {
  loadByIds: function loadByIds(ids) {
    return fetch(baseUrl + '/group?' + params + '&id=' + ids).then(function (response) {
      return response.json();
    });
  },
  findByCityName: function findByCityName(name) {
    return fetch(baseUrl + '/find?' + params + '&q=' + name).then(function (response) {
      return response.json();
    });
  },
  findByCoordinates: function findByCoordinates(_ref) {
    var lat = _ref.lat,
        lon = _ref.lon;

    return fetch(baseUrl + '/weather?' + params + '&lat=' + lat + '&lon=' + lon).then(function (response) {
      return response.json();
    });
  }
};
...
exports.default = {
  api: {
    ...
    key: 'de1d40a790b506636e2f125ec672ad40',
    type: 'accurate',
    units: 'metric'
  },
  favorites: {
...
var SET_FAVORITES_LOADING = exports.SET_FAVORITES_LOADING = 'SET_FAVORITES_LOADING';
...
var SET_GEOLOCATION_ERROR = exports.SET_GEOLOCATION_ERROR = 'SET_GEOLOCATION_ERROR';
var SET_GEOLOCATION_LOADING = exports.SET_GEOLOCATION_LOADING = 'SET_GEOLOCATION_LOADING';
...
var _IconButton = __webpack_require__(29);

var _IconButton2 = _interopRequireDefault(_IconButton);

var _WeatherIcon = __webpack_require__(31);
...
var WeatherCard = function (_React$Component) {
  ...
  function WeatherCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WeatherCard.__proto__ || Object.getPrototypeOf(WeatherCard)).call.apply(_ref, [this].concat(args))), _this), _this.handleButtonClick = function () {
      _this.props.onDelete(_this.props.weather.id);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_WeatherIcon2.default, { icon: weather.weather[0].icon })
        ),
        _react2.default.createElement(
          'div',
...
WeatherCard.propTypes = {
  weather: _propTypes2.default.object.isRequired,
...
var Icon = function (_React$Component) {
  ...
  _createClass(Icon, [{
    key: 'render',
    value: function render() {
      var href = './img/icons.svg#' + this.props.icon;
...
var WeatherIcon = function (_React$Component) {
  ...
  _createClass(WeatherIcon, [{
    ...
    value: function render() {
      ...
      var classNameSmall = isSmall ? 'weather-icon--small' : '';

      return _react2.default.createElement(
        'div',
        { className: 'weather-icon ' + classNameSmall },
        _react2.default.createElement('img', {
          className: 'weather-icon__image',
...
var _favoritesActionTypes = __webpack_require__(25);

var _storageService = __webpack_require__(88);
...
function addFavoriteToState(item) {
  return {
    item: item,
    type: _favoritesActionTypes.ADD_FAVORITE
  };
}

function addFavorite(item) {
  return function (dispatch, getState) {
    if (getState().favorites.items.length >= _config2.default.favorites.limit) {
      return;
    }

    dispatch(addFavoriteToState(item));

    var items = getState().favorites.items;
    _storageService2.default.setData('favorites', items);
  };
}

function deleteFavoriteFromState(id) {
  return {
    id: id,
    type: _favoritesActionTypes.DELETE_FAVORITE
  };
}

function deleteFavorite(id) {
  return function (dispatch, getState) {
    dispatch(deleteFavoriteFromState(id));

    var favorites = getState().favorites.items;
    _storageService2.default.setData('favorites', favorites);
  };
}

function loadFavorites() {
  return function (dispatch) {
    var favorites = _storageService2.default.getData('favorites');
    ...
    if (favorites !== null && favorites.length !== 0) {
      ...
      _apiService2.default.loadByIds(ids).then(function (_ref) {
        var list = _ref.list;

        dispatch(setFavorites(list));
        _storageService2.default.setData('favorites', list);
...
function setFavorites(items) {
  return {
    items: items,
    type: _favoritesActionTypes.SET_FAVORITES
  };
}

function setFavoritesLoading(status) {
  return {
    status: status,
    type: _favoritesActionTypes.SET_FAVORITES_LOADING
  };
}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var invariant=__webpack_require__(3);var React=__webpack_require__(1);var warning=__webpack_require__(8);var ExecutionEnvironment=__webpack_require__(15);var _assign=__webpack_require__(5);var emptyFunction=__webpack_require__(4);var checkPropTypes=__webpack_require__(9);var getActiveElement=__webpack_require__(16);var shallowEqual=__webpack_require__(17);var containsNode=__webpack_require__(18);var emptyObject=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(41);var camelizeStyleName=__webpack_require__(43);// Relying on the `invariant()` implementation lets us
// have preserve the format and params in the www builds.
...
var _baseGetTag = __webpack_require__(58);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(63);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(65);
...
var _getRawTag = __webpack_require__(61);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(62);
...
var _overArg = __webpack_require__(64);
...
var _favoritesReducer = __webpack_require__(73);

var _favoritesReducer2 = _interopRequireDefault(_favoritesReducer);

var _geoLocationReducer = __webpack_require__(74);

var _geoLocationReducer2 = _interopRequireDefault(_geoLocationReducer);

var _searchReducer = __webpack_require__(75);
...
function favorites() {
  ...
  switch (action.type) {
    case _favoritesActionTypes.ADD_FAVORITE:
    ...
    case _favoritesActionTypes.DELETE_FAVORITE:
      return _extends({}, state, {
        items: state.items.filter(function (item) {
          return item.id !== action.id;
        })
      });
    case _favoritesActionTypes.SET_FAVORITES:
      return _extends({}, state, {
        items: action.items
      });
    case _favoritesActionTypes.SET_FAVORITES_LOADING:
      return _extends({}, state, {
...
var _geoLocationActionTypes = __webpack_require__(26);
...
function geoLocation() {
  ...
  switch (action.type) {
    case _geoLocationActionTypes.SET_GEOLOCATION:
      return _extends({}, state, {
        weather: action.weather
      });
    case _geoLocationActionTypes.SET_GEOLOCATION_ERROR:
      return _extends({}, state, {
        isError: action.status
      });
    case _geoLocationActionTypes.SET_GEOLOCATION_LOADING:
      return _extends({}, state, {
        isLoading: action.status
      });
    default:
...
var _searchActionTypes = __webpack_require__(27);
...
function search() {
  ...
  switch (action.type) {
    case _searchActionTypes.SET_SEARCH_RESULTS:
      return action.results;
    case _searchActionTypes.CLEAR_SEARCH_RESULTS:
      return [];
    default:
      return state;
  }
...
var _Current = __webpack_require__(79);
...
var _Favorites = __webpack_require__(94);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var _props = this.props,
          isLoadingFavorites = _props.isLoadingFavorites,
          isLoadingGeoLocation = _props.isLoadingGeoLocation;

      var isLoading = isLoadingFavorites || isLoadingGeoLocation;
...
App.propTypes = {
  isLoadingFavorites: _propTypes2.default.bool,
  isLoadingGeoLocation: _propTypes2.default.bool
};
App.defaultProps = {
...
function mapStateToProps(state) {
  return {
    ...
    isLoadingGeoLocation: state.geoLocation.isLoading
  };
}
...
var _geoLocationActions = __webpack_require__(80);

var _WeatherCard = __webpack_require__(28);
  ...
  _createClass(Current, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'current' },
        isError || weather.id === undefined ? _react2.default.createElement(
          'div',
          { className: 'current__error' },
          'Failed to get location data'
        ) : _react2.default.createElement(_WeatherCard2.default, { weather: weather })
      );
    }
  }]);
...
Current.propTypes = {
  ...
  weather: _propTypes2.default.object
};
...
function mapDispatchToProps(dispatch) {
  return {
    onMount: function onMount() {
      dispatch((0, _geoLocationActions.loadGeoLocation)());
    }
  };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Current);
...
exports.loadGeoLocation = loadGeoLocation;
exports.setGeoLocation = setGeoLocation;
exports.setGeoLocationError = setGeoLocationError;
exports.setGeoLocationLoading = setGeoLocationLoading;
...
var _geoLocationService = __webpack_require__(81);

var _geoLocationService2 = _interopRequireDefault(_geoLocationService);
...
function loadGeoLocation() {
  return function (dispatch) {
    ...
    _geoLocationService2.default.getPosition().then(function (coords) {
      return _apiService2.default.findByCoordinates(coords);
    }).then(function (weather) {
      dispatch(setGeoLocation(weather));
      dispatch(setGeoLocationLoading(false));
    }).catch(function (error) {
      dispatch(setGeoLocationLoading(false));
      dispatch(setGeoLocationError(true));
    });
  };
}

function setGeoLocation(weather) {
  return {
    weather: weather,
    type: _geoLocationActionTypes.SET_GEOLOCATION
  };
}

function setGeoLocationError(status) {
  return {
    status: status,
    type: _geoLocationActionTypes.SET_GEOLOCATION_ERROR
  };
}

function setGeoLocationLoading(status) {
  return {
    status: status,
    type: _geoLocationActionTypes.SET_GEOLOCATION_LOADING
  };
}
...
var _config$geoLocation = _config2.default.geoLocation,
    defaultCoords = _config$geoLocation.defaultCoords,
    options = _config$geoLocation.options;
exports.default = {
...
var _favoritesActions = __webpack_require__(32);

var _searchActions = __webpack_require__(89);

var _SearchForm = __webpack_require__(90);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onClickResultItem: function onClickResultItem(item) {
      dispatch((0, _favoritesActions.addFavorite)(item));
    },
    onSearch: function onSearch(query) {
      if (query.length > 2) {
        dispatch((0, _searchActions.search)(query));
      } else {
        dispatch((0, _searchActions.clearSearchResults)());
      }
    },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_SearchForm2.default);
...
function search(query) {
  return function (dispatch) {
    _apiService2.default.findByCityName(query).then(function (_ref) {
      var list = _ref.list;

      // TODO: API openweathermap в запросе find может возвращать несколько элементов с одним и тем же ID,
      // которые используюся как key при рендере списка результатов, по этому пришлось отфильтровать список
      // для удаления пунктов с повторными id
      var filteredList = list.filter(function (item, index) {
        return list.findIndex(function (it) {
          return it.id === item.id;
        }) === index;
      });

      dispatch(setSearchResults(filteredList));
    });
  };
}
...
function setSearchResults(results) {
  return {
    results: results,
    type: _searchActionTypes.SET_SEARCH_RESULTS
  };
}

function clearSearchResults() {
  return {
    type: _searchActionTypes.CLEAR_SEARCH_RESULTS
  };
}
...
var _SearchResultListItem = __webpack_require__(91);
...
var SearchForm = function (_React$Component) {
  ...
  function SearchForm() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchForm.__proto__ || Object.getPrototypeOf(SearchForm)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.handleClear();
      _this.props.onClickResultItem(item);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.results.map(function (item) {
            return _react2.default.createElement(_SearchResultListItem2.default, {
              key: item.id,
              item: item,
...
SearchForm.propTypes = {
  ...
  onClearResults: _propTypes2.default.func,
  onClickResultItem: _propTypes2.default.func,
  onSearch: _propTypes2.default.func
};
SearchForm.defaultProps = {
  results: [],
  onClearResults: function onClearResults() {},
  onClickResultItem: function onClickResultItem() {},
...
var SearchResultListItem = function (_React$Component) {
  ...
  function SearchResultListItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchResultListItem.__proto__ || Object.getPrototypeOf(SearchResultListItem)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
  ...
  _createClass(SearchResultListItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'search-result-list-item__icon' },
          _react2.default.createElement(_WeatherIcon2.default, {
        ...
        _react2.default.createElement(
          'div',
          { className: 'search-result-list-item__name' },
          item.name,
          ', ',
          item.sys.country
        ),
        _react2.default.createElement(
          'div',
          { className: 'search-result-list-item__description' },
          item.weather[0].description
        ),
        _react2.default.createElement(
          'div',
          { className: 'search-result-list-item__temperature' },
          item.main.temp,
          '\xB0'
        )
      );
...
var _WeatherGrid = __webpack_require__(95);

var _WeatherGrid2 = _interopRequireDefault(_WeatherGrid);
...
function mapDispatchToProps(dispatch) {
  return {
    onDelete: function onDelete(id) {
      dispatch((0, _favoritesActions.deleteFavorite)(id));
    },
    onMount: function onMount() {
      dispatch((0, _favoritesActions.loadFavorites)());
    }
  };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_WeatherGrid2.default);
...
var WeatherGrid = function (_React$Component) {
  _inherits(WeatherGrid, _React$Component);
  ...
  function WeatherGrid() {
    ...
    _classCallCheck(this, WeatherGrid);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WeatherGrid.__proto__ || Object.getPrototypeOf(WeatherGrid)).call.apply(_ref, [this].concat(args))), _this), _this.handleDelete = function (id) {
      _this.props.onDelete(id);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(WeatherGrid, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      this.props.onMount();
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.items.map(function (item) {
          return _react2.default.createElement(_WeatherCard2.default, {
            key: item.id,
            weather: item,
...
WeatherGrid.defaultProps = {
  items: [],
  onDelete: function onDelete() {},
  onMount: function onMount() {}
};
exports.default = WeatherGrid;
